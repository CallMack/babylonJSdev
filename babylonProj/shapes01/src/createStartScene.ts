...
function createSphere(scene: Scene) {
  ...
  texture.emissiveTexture = new Texture("./Assets/texture/lavatile.jpg", scene);
...
function createBox(scene: Scene) {
  ...
  texture.ambientTexture = new Texture("./assets/texture/reflectivity.jpg", scene);
...
function createPlane(scene: Scene) {
  ...
  var texture = new StandardMaterial("reflective", scene);
  texture.ambientTexture = new Texture("./assets/texture/wood.jpg", scene);
  texture.diffuseColor = new Color3(1, 1, 1);
